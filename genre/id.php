...
<head>
    <title><?=$id?> on AniKatsu</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="<?=$id?> on AniKatsu">
    ...
    <meta property="og:title" content="<?=$id?> on AniKatsu">
    <meta property="og:description" content="<?=$id?> on AniKatsu in HD with No Ads. Watch anime online">
                            ...
                            <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature">
                                ...
                                <div class="pagination">
                                    <nav>
                                        ...
                                        <?php 
                                           $genreFetchPage = file_get_contents("$apiLink/getGenrePage/$genre/$page");
