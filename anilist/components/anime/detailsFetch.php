                        ...
                        <div class="anis-content">
                            ...
                            <div class="anisc-detail">
                                ...
                                <div class="film-buttons">
                                    <a href="<?=$websiteUrl?>/watch/<?php foreach(array_slice($episodelist, 0, 1) as $episode1) {?><?=$episode1['id']?><?php } ?>" class="btn btn-radius btn-primary btn-play"><i
                                            ...
                                            <div class="dr-fav" id="watch-list-content"><a target="_blank" href="https://myanimelist.net/anime/<?=$getAnime['malId']?>"><i class="fas fa-list mr-2"></i>MyAnimeList</a></div>
                                </div>
                                <?php } ?>
                                <div class="film-description m-hide">
                                    <div class="text"><?=$getAnime['description']?></div>
                                </div>
                                <div class="film-text m-hide"><?=$websiteTitle?> is a site to watch online anime like <strong><?=$title['romaji']?></strong> online, or you can even watch <strong><?=$title['romaji']?></strong> in HD quality</div>
                            ...
                            <div class="anisc-info-wrap">
                                <div class="anisc-info">
                                    ...
                                    <div class="film-text w-hide"><?=$websiteTitle?> is a site to watch online anime like <strong><?=$title['romaji']?></strong> online, or you can even watch <strong><?=$title['romaji']?></strong> in HD quality</div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="clearfix"></div>
