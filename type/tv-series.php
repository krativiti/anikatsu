...
<head>
    <title>Tv Series on AniKatsu</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Tv Series on AniKatsu">
    ...
    <meta property="og:title" content="Tv Series on AniKatsu">
    <meta property="og:description" content="Tv Series on AniKatsu in HD with No Ads. Watch anime online">
                    ...
                    <section class="block_area block_area_category">
                        ...
                        <div class="tab-content">
                            <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature">
                                ...
                                <?php 
                                $json = file_get_contents("$apiLink/getSubCategory/tv-series/$page");
                                ...
                                <div class="pagination">
                                    <nav>
                                        ...
                                        <?php 
                                           $tvSeriesPage = file_get_contents("$apiLink/subCategoryPage/tv-series/$page");
